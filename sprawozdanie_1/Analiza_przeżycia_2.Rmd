...
print(tabela, type='latex', table.placement='H', caption.placement='bottom', include.rownames=FALSE,  comment = FALSE)
...
print(tabela, caption.placement='bottom',table.placement='H',include.rownames=FALSE,  comment = FALSE)
