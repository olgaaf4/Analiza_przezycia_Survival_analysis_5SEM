...
print(tabela, type='latex', table.placement='H', caption.placement='bottom', include.rownames=TRUE)
...
print(tabela1, type='latex', table.placement='H', caption.placement='bottom', include.rownames=TRUE)
