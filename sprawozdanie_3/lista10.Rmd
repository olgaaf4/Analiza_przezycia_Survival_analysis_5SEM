...
plot(x,y, main="Skumulowana funkcja hazardu", col="darkblue", ylab="prawdopodobieństwo", xlab="czas")
plot(x,y1, main="Funkcja przeżycia", col="darkblue", xlab="czas", ylab="sk.funkcja hazardu")
```
...
Hz1<- -log(Sz1)
plot(t,Hz1, type="l", lwd=1, xlab="czas", ylab="skumulowana f.hazardu",main="Wykres dla skumulowanej f.hazardu" )

plot(t,log(Hz1), type="l", lwd=1, xlab="czas", ylab="skumulowana f.hazardu", main="Wykres dla logarytmu skumulowanej f.hazardu")
```
...
Hz2<- -log(Sz2)
plot(t,Hz2, type="l", lwd=1, xlab="czas", ylab="skumulowana f.hazardu" , main="Wykres dla skumulowanej f.hazardu")

plot(t,log(Hz2), type="l", lwd=1, xlab="czas", ylab="logarytm skumulowanej f.hazardu", main="Wykres dla logarytmu skumulowanej f.hazardu")
```
