...
histogramy <- function(alfa,lambda,t0,m,n_list){
  for(n in n_list){
    ...
    hist(st0, col = "lightblue", main = paste("n =", n, " | Estymator S(t0)"), xlab = "Wartość S(t0)")
    hist(s2t0, col = "aquamarine",main = paste("n =", n, " | Estymator S(2 * t0)"), xlab = "Wartość S(2 * t0)")
  }
}
